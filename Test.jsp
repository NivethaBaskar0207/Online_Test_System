...
<h1>Test</h1>
<hr/>
<form method = "POST" method = "form-group" action = "TestResults.jsp">
...
Connection connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_quiz?useTimezone=true&serverTimezone=UTC","root","root");
